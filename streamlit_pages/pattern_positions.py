...
def create_heatmap(glob, pattern, pitch, titles=None, bw0=0.3, bw1=0.2, show_start=True, show_end=True):
    """
        ...
        if st.form_submit_button("Create the plot"):
            ...
            for pattern in ["ABAC", "ABAB", "ABCD", "ABCA", "ABCB"]:
                try:
                    ...
                    if type == "Heatmap":
                        create_heatmap(a, pattern, pitch=pitch, bw0=bw1, bw1=bw2, show_start=show_start, show_end=show_end)
                    elif type == "Flow":
            ...
            if type == "Heatmap":
                create_heatmap(vertical_glob, "AAAA", pitch,
                       ["Overall location of p0", "Overall location of p1", "Overall location of p2",
                        "Overall location"], bw0=bw1, bw1=bw2, show_start=show_start, show_end=show_end)
            elif type == "Flow":
                create_flowmap(vertical_glob, "AAAA", pitch,
                           ["Overall of p0", "Overall of p1", "Overall of p2", "Overall "], )
            elif type == "Arrows":
                create_arrowmap(vertical_glob, "AAAA", pitch,
                           ["Overall location of p0", "Overall location of p1", "Overall location of p2",
                            "Overall location"], )
